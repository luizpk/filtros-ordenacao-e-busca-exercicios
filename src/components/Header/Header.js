...
const Header = (props) => {
  ...
  const onChangeOrdenação = (e) => {
    props.setOrdenaAlfabeto(e.target.value)
  }

  const onChangeTipo = (e) => {
    props.setOrdenarTipo(e.target.value)
  }
  ...
  return (
    <Container>
      ...
      <select value={props.OrdenaAlfabeto} onChange={onChangeOrdenação}>
        <option value="">Ordenar</option>
        <option value="crescente">Crescente</option>
        <option value="decrescente">Decrescente</option>
      </select>
      <select name="tipo" id="tipo" value={props.ordenarTipo} onChange={onChangeTipo} >
